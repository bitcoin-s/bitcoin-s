...
class HomeSplash extends React.Component {
    ...
    >
        ...
        className = "homeSplashFade" >
            < div
        className = "wrapper homeWrapper" > {props.children} < /div>
            < /div>
            < /div>
    )
        ;
    ...
    >
        ...
        className = "promoRow" >
            < div
        className = "pluginRowBlock" > {props.children} < /div>
            < /div>
            < /div>
    )
        ;
...
class Index extends React.Component {
    ...
    >
        ...
        className = "hero__container" >
            < Logo
        img_src = {`${siteConfig.baseUrl}img/bitcoin-s-logo.svg`
    }
        />
    ...
    >
                    ...
                    },
        {
            content: [
                ...
                image
        :
            `${baseUrl}img/undraw_code_review_l1q9.svg`,
                imageAlign
        :
            "top",
                title
    ...
    ,
        {
            content: [
                ...
                image
        :
            `${baseUrl}img/undraw_mathematics_4otb.svg`,
                imageAlign
        :
            "top",
                title
