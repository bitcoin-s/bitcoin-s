...
function Versions(props) {
    ...
    className = "docMainWrapper wrapper" >
        < Container
    className = "mainContainer versionsContainer" >
        < div
    className = "post" >
        < header
...
>
    ...
    < td >
    < a
    href = {siteConfig.scaladocUrl} > Scaladoc < /a>
        < /td>
        < td >
        < a
...
<
    a
    href = "https://oss.sonatype.org/content/repositories/snapshots/org/bitcoin-s/" >
        Sonatype
        < /a>
            .
        < /p>
