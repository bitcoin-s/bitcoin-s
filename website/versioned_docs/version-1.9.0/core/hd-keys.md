...
// entropy: BitVector = BitVector(256 bits, 0xb69e6f43bf72c667ec90942fcfef1ef001eaf4ec6269dee164a567d648e1f1fa)

val mnemonicCode = MnemonicCode.fromEntropy(entropy)
// mnemonicCode: MnemonicCode = Masked(MnemonicCodeImpl)

mnemonicCode.words // the phrase the user should write down
// res0: Vector[String] = Vector(repair, vibrant, special, leave, cluster, crop, rather, barely, cool, legal, sibling, theme, burger, kidney, ranch, essay, ten, arctic, citizen, soul, goose, ill, side, equip) // the phrase the user should write down
...
// xpub: ExtPublicKey = zpub6jftahH18ngZxPbbbs9U9Mg5qceaiY5gPKiuJBLj4APHVMTjHr9uKbKG6HQJqXfrVWeYtwWZE4fatN8fPFTkk76sFEyZhnu5YB61KZmdzq8
...
// accountXpub: ExtPublicKey = zpub6s35CeDCxYMFwdxoQz4EgZFH2AjWdRZD6VpzMwEEAX7q9EqcGUW5qYfK8sQxWR1NoP65DuvvQvnaMDpUcXcqUN8HeB1XToseVcM63UZ6LFt
...
// firstAccountAddress: Bech32Address = tb1qxyhnhvy8ekrjpqcx9s75726ue7t26yzlt7s0rf

// tada! We just generated an address you can send money to,
// without having access to the private key!
firstAccountAddress.value
// res2: String = tb1qxyhnhvy8ekrjpqcx9s75726ue7t26yzlt7s0rf
