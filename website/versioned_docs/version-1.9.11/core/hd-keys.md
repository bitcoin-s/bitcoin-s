...
// entropy: BitVector = BitVector(256 bits, 0xd63c7ed808f0b71b71c3867ea81b6df0993b7dfca400e48892af2e137243184c)

val mnemonicCode = MnemonicCode.fromEntropy(entropy)
// mnemonicCode: MnemonicCode = Masked(MnemonicCodeImpl)

mnemonicCode.words // the phrase the user should write down
// res0: Vector[String] = Vector(stomach, token, render, ball, arena, misery, shove, ignore, leaf, dolphin, swarm, thrive, neck, same, verb, length, tonight, duty, profit, found, damp, canoe, gentle, oblige)
...
// xpub: ExtPublicKey = zpub6jftahH18ngZxoCUxrSyHhpmisbisfQk32nf11QqZ928gPbW4BfrNfSPmaSdtDk6oKH6xc1EfXs9eTPcjE9SMehmYjP4K3xQipVapW7ZZqe
...
// accountXpub: ExtPublicKey = zpub6rsf8vrFbDariRHNwS9A8vtt5s3f4wUpACCLzNYBJc7cn9RHg3sPy8X1qYnFisrXMoeC5FdrM4oQaWw6YfeKCwEqtYLcmaNM1VGvpPJ4tri
...
// firstAccountAddress: Bech32Address = tb1qzmw0dx93yy46c6mx2egxyj4l56nydd3tt3zrdq

// tada! We just generated an address you can send money to,
// without having access to the private key!
firstAccountAddress.value
// res2: String = tb1qzmw0dx93yy46c6mx2egxyj4l56nydd3tt3zrdq
