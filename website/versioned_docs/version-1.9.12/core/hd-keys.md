...
// entropy: BitVector = BitVector(256 bits, 0x5117e2cc4a222cae752d99e851f18c981da43ef6bce5eef7e2ced0385a929159)

val mnemonicCode = MnemonicCode.fromEntropy(entropy)
// mnemonicCode: MnemonicCode = Masked(MnemonicCodeImpl)

mnemonicCode.words // the phrase the user should write down
// res0: Vector[String] = Vector(extra, sample, reason, nephew, carpet, fire, start, rebel, tribe, moon, glimpse, coral, surge, buyer, sustain, original, upon, sample, recipe, parrot, mad, enable, earth, cattle)
...
// xpub: ExtPublicKey = zpub6jftahH18ngZyGwBzF2cAPkryKW1fwEET98znb6Sqk8VcVRvhKdQerPbya3ET2TqEZMXeBUeci29nsbh2NB2GCygQE2p1JVLMuPDdb2hrv3
...
// accountXpub: ExtPublicKey = zpub6qVVFJ3xEZP49YDs7A35CfyE4wTEWAwMkn5C2s2B5efrNwBN265TuNhaaZNT9RAH8p9Y8vKNMxucjeT2kwL4ESGGW72jHscK71vJUA2h5K2
...
// firstAccountAddress: Bech32Address = tb1qym94akzuchqn28vj85nrky57v09pn5ggdaa0pp

// tada! We just generated an address you can send money to,
// without having access to the private key!
firstAccountAddress.value
// res2: String = tb1qym94akzuchqn28vj85nrky57v09pn5ggdaa0pp
