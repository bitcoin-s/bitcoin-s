...
// entropy: scodec.bits.BitVector = BitVector(256 bits, 0x582ae7197600c2bb49a3ac103196a169ddb9b16b908256fb7df24acf4b63ec0c)
...
// Vector(flag, fire, shock, ugly, around, frozen, charge, intact, awake, million, portion, squirrel, swear, suffer, purity, aware, finger, swim, lady, night, visa, rapid, rabbit, motor)
```
...
// seedPath: Path = /var/folders/00/27b127nj25q8gnjhjqfnw9040000gn/T/key-manager-example11200482697730527833/encrypted-bitcoin-s-seed.json
...
// kmParams: KeyManagerParams = KeyManagerParams(/var/folders/00/27b127nj25q8gnjhjqfnw9040000gn/T/key-manager-example11200482697730527833/encrypted-bitcoin-s-seed.json,m/84',RegTest)
...
// km: Either[KeyManagerInitializeError, BIP39KeyManager] = Right(org.bitcoins.keymanager.bip39.BIP39KeyManager@403882ba)

val rootXPub = km.right.get.getRootXPub
// rootXPub: ExtPublicKey = vpub5SLqN2bLY4WeZtKwQDkmCX7awSKgSdfmeiZ2fQNCUXoAQ9DCmrTtVNzQHYoW5cQjHneK7yWMj1rjYJAMcjUbDzUAx9Vn3KEBJscdeaTeqaU

println(rootXPub)
// vpub5SLqN2bLY4WeZtKwQDkmCX7awSKgSdfmeiZ2fQNCUXoAQ9DCmrTtVNzQHYoW5cQjHneK7yWMj1rjYJAMcjUbDzUAx9Vn3KEBJscdeaTeqaU
```
...
// mainnetKmParams: KeyManagerParams = KeyManagerParams(/var/folders/00/27b127nj25q8gnjhjqfnw9040000gn/T/key-manager-example11200482697730527833/encrypted-bitcoin-s-seed.json,m/84',MainNet)

//we do not need to all `initializeWithMnemonic()` again as we have saved the seed to dis
val mainnetKeyManager = BIP39KeyManager.fromMnemonic(mnemonic, mainnetKmParams, None, Instant.now, false)
// mainnetKeyManager: BIP39KeyManager = org.bitcoins.keymanager.bip39.BIP39KeyManager@9ad6cc9

val mainnetXpub = mainnetKeyManager.getRootXPub
// mainnetXpub: ExtPublicKey = zpub6jftahH18ngZy56QjeuG2sVbdJuUD7dmKAdunywjzZJgcYU7nV88ydcxNNdr5F2QvM7Y7stbZfGw5SccVX8eQwCaRWHUNxW8PmsDCyrZ5gc

println(mainnetXpub)
// zpub6jftahH18ngZy56QjeuG2sVbdJuUD7dmKAdunywjzZJgcYU7nV88ydcxNNdr5F2QvM7Y7stbZfGw5SccVX8eQwCaRWHUNxW8PmsDCyrZ5gc
```
