...
abstract class DLCDialog[T <: CliCommand](
  ...
  readCachedValue(DLCDialog.dlcEventIdStr, GlobalData.lastEventId)
  readCachedValue(DLCDialog.dlcOracleSigStr, GlobalData.lastOracleSig)
  readCachedValue(DLCDialog.oracleInfoStr, GlobalData.lastOracleInfo)
  readCachedValue(DLCDialog.contractInfoStr, GlobalData.lastContractInfo)
...
object DLCDialog {
  ...
  val allOfferFields = Vector(oracleInfoStr,
                              contractInfoStr,
                              collateralStr,
                              feeRateStr,
                              locktimeStr,
  ...
  def constructOfferFields(): Vector[(String, TextField)] =
    allOfferFields.map(_ -> new TextField())
