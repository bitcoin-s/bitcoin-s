...
object TradingPair {
  ...
  def fromStringOpt(pair: String): Option[TradingPair] = {
    ...
    val pairOpt =
      all.find(
        tradingPair => tradingPair.toUpperString == translatedPair.toUpperCase
      )
...
object BitfinexTradingPair extends TradingPairObject[BitfinexTradingPair] {
  ...
  def all: Vector[BitfinexTradingPair] = Vector(
    TradingPair.BTCUSD,
    TradingPair.ETHUSD,
    TradingPair.ETHBTC,
    TradingPair.LTCUSD,
...
object BinanceTradingPair extends TradingPairObject[BinanceTradingPair] {
  ...
  def all: Vector[BinanceTradingPair] = Vector(
    TradingPair.BTCUSDT,
    TradingPair.ETHUSDT,
    TradingPair.ETHBTC,
    TradingPair.LTCUSDT,
...
object CoinbaseTradingPair extends TradingPairObject[CoinbaseTradingPair] {
  ...
  def all: Vector[CoinbaseTradingPair] = Vector(
    TradingPair.BTCUSD,
    TradingPair.ETHUSD,
    TradingPair.ETHBTC,
    TradingPair.LTCUSD,
...
object BitstampTradingPair extends TradingPairObject[BitstampTradingPair] {
  ...
  def all: Vector[BitstampTradingPair] = Vector(
    TradingPair.BTCUSD,
    TradingPair.ETHUSD,
    TradingPair.ETHBTC,
    TradingPair.LTCUSD,
