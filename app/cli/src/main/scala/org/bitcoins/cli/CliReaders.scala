...
object CliReaders {
  ...
  implicit val announcementReads: Read[OracleAnnouncementV1TLV] =
    new Read[OracleAnnouncementV1TLV] {
      val arity: Int = 1

      val reads: String => OracleAnnouncementV1TLV =
        OracleAnnouncementV1TLV.fromHex
    }
