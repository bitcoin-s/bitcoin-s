...
object GCS {
  ...
  /** Given data, constructs a GolombFilter for that data using Basic Block
    * Filter parameters
    * @see
  ...
  /** Converts num to unary (6 = 1111110)
    ...
    *
    * TODO: protect against large inputs which cause OutOfMemoryErrors and even
    * larger ones which fail on toInt
    */
  ...
  /** Decodes an item off of the front of a BitVector by reversing
    * [[GCS.golombEncode]]
    * @see
    *   [[https://github.com/bitcoin/bips/blob/master/bip-0158.mediawiki#golomb-rice-coding]]
    */
  ...
  /** Returns the first hash gcs-encoded at the front of a BitVector, as well as
    * the remaining BitVector
    */
  ...
  /** Decodes all hashes from golomb-encoded data, reversing
    * [[GCS.encodeSortedSet]]
    * @see
