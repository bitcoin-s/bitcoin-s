...
/** Created by chris on 8/3/16. Specifies how to update a bloom filter
...
/** If the filter matches any data element in a pubkey script and that
  * scriptPubKey is either a P2PKH or non-P2SH pay-to-multisig script, the
  * outpoint for this transaction is added to the filter.
  */
