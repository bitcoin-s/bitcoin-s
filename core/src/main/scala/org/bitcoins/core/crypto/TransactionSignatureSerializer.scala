    ...
    txSigComponent.sigVersion match {
      case SigVersionBase =>
        ...
        hashType match {
          ...
          case _: SIGHASH_ALL =>
            val sigHashAllTx: Transaction =
              sigHashAll(txWithInputSigsRemoved, inputIndex)
