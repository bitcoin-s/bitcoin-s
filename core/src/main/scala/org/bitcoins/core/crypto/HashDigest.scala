...
object Sha256Digest extends Factory[Sha256Digest] {
  ...
  override def fromBytes(bytes: Seq[Byte]): Sha256Digest =
...
object DoubleSha256Digest extends Factory[DoubleSha256Digest] {
  private case class DoubleSha256DigestImpl(bytes: Seq[Byte])
  ...
  override def fromBytes(bytes: Seq[Byte]): DoubleSha256Digest =
...
object RipeMd160Digest extends Factory[RipeMd160Digest] {
  private case class RipeMd160DigestImpl(bytes: Seq[Byte])
  ...
  override def fromBytes(bytes: Seq[Byte]): RipeMd160Digest =
...
object Sha256Hash160Digest extends Factory[Sha256Hash160Digest] {
  private case class Sha256Hash160DigestImpl(bytes: Seq[Byte])
  ...
  override def fromBytes(bytes: Seq[Byte]): Sha256Hash160Digest =
