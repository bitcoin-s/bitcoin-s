...
/** @see
  *   [[https://github.com/satoshilabs/slips/blob/master/slip-0132.md#registered-hd-version-bytes SLIP132]]
...
object ExtKeyPubVersion extends Factory[ExtKeyPubVersion] {
  ...
  /** Generating a [[org.bitcoins.core.crypto.ExtPublicKey ExtPublicKey]] with
    * this version makes keys start with `upub`
    *
    * @see
    *   [[https://github.com/trezor/trezor-firmware/blob/master/common/defs/bitcoin/bitcoin_testnet.json#L17 Trezor]]
    * @see
    *   [[https://github.com/Samourai-Wallet/ExtLibJ/blob/87fcb87f87ed86c38d4b82aefac6c59ec981bdad/java/com/samourai/wallet/util/FormatsUtilGeneric.java#L33 Samourai wallet]]
    */
  ...
  /** Generating a [[org.bitcoins.core.crypto.ExtPublicKey ExtPublicKey]] with
    * this version makes keys start with `ypub`
    *
    * @see
    *   [[https://github.com/Samourai-Wallet/ExtLibJ/blob/87fcb87f87ed86c38d4b82aefac6c59ec981bdad/java/com/samourai/wallet/util/FormatsUtilGeneric.java#L32 Samourai Wallet]]
    */
  ...
  /** Generating a [[org.bitcoins.core.crypto.ExtPublicKey ExtPublicKey]] with
    * this version makes keys start with `vpub`
    */
  ...
  /** Generating a [[org.bitcoins.core.crypto.ExtPublicKey ExtPublicKey]] with
    * this version makes keys start with `tpub`
    */
  ...
  /** Generating a [[org.bitcoins.core.crypto.ExtPublicKey ExtPublicKey]] with
    * this version makes keys start with `zpub`
    */
