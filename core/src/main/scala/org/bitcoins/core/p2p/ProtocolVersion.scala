...
/** The peer to peer network has versions to allow for new operations Here are
  * the currently protocol versions in the network
  * @see
...
/** Added receive IP address fields to version message. Bitcoin Core 0.1.6 (Oct
  * 2009)
  */
...
/** BIP14: Separated protocol version from Bitcoin Core version Bitcoin Core
  * 0.6.0 (Mar 2012)
  */
...
/** BIP31: Added nonce field to ping message, Added pong message Bitcoin Core
  * 0.6.1 (May 2012)
  */
...
/** BIP35: Added mempool message. • Extended getdata message to allow download
  * of memory pool transactions Bitcoin Core 0.7.0 (Sep 2012)
  */
case object ProtocolVersion60002 extends ProtocolVersion {
  override val bytes: ByteVector = hex"62ea0000"
}

/** Added notfound message. BIP37: • Added filterload message. • Added filteradd
  * message. • Added filterclear message. • Added merkleblock message. • Added
  * relay field to version message • Added MSG_FILTERED_BLOCK inventory type to
  * getdata message. Bitcoin Core 0.8.0 (Feb 2013)
  */
...
/** Send multiple inv messages in response to a mempool message if necessary
  * BIP61: Add reject message Bitcoin Core 0.9.0 (Mar 2014)
  */
...
/** Added feefilter message. Removed alert message system. See Alert System
  * Retirement Bitcoin Core 0.13.0 (August 2016)
  */
case object ProtocolVersion70013 extends ProtocolVersion {
  override val bytes: ByteVector = hex"7d110100"
}

/** BIP152 Added sendcmpct, cmpctblock, getblocktxn, blocktxn messages Added
  * MSG_CMPCT_BLOCK inventory type to getdata message. Bitcoin Core 0.13.0
  * (August 2016)
  */
...
/** New banning behavior for invalid compact blocks #9026 in v0.14.0, Backported
  * to v0.13.2 in #9048. Bitcoin Core 0.13.2 (January 2017)
  */
...
/** Indicates that a node prefers to relay transactions via wtxid, rather than
  * txid. Protocol version 70016 as described by BIP 339. Bitcoin Core 0.21.0
  * (December 2020)
  */
