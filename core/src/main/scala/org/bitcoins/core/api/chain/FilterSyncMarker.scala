...
/** This is a helper class for syncing block filters following the BIP157
  * protocol. This indicates the starting block height we are syncing filters
  * at, and the last block hash we expect in the batch of filters sent back to
  * us by our peer
  * @see
