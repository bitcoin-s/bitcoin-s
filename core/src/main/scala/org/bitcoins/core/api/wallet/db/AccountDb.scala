...
/** Represents the xpub at the account level, NOT the root xpub that in
  * conjunction with the path specified in hdAccount can be used to generate the
  * account level xpub m / purpose' / coin_type' / account'
  *
  * @see
