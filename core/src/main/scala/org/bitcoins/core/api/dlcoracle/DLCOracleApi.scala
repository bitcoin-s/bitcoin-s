...
trait DLCOracleApi {
  ...
  /** Deletes an announcement with the given name WARNING: If this announcement
    * has been published widely users will not be able to settle their DLCs. You
    * likely should only use this in testing scenarios
    * @return
  ...
  /** Returns the staking address private key in wallet import format so a user
    * can take it an recover the funds in another wallet
    */
