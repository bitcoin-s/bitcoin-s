...
/** Created by chris on 1/11/16. A common trait for reading/writing bitcoin
  * objects to/from bytes/hex
  */
abstract class RawBitcoinSerializer[T] {
  ...
  /** Takes a type T and writes it into the appropriate hexadecimal
    * serialization for type T.
    */
