...
sealed abstract class RawTransactionWitnessParser {
  ...
  /** We can only tell how many
    * [[org.bitcoins.core.protocol.script.ScriptWitness ScriptWitness]] we have
    * if we have the number of inputs the transaction creates
    */
