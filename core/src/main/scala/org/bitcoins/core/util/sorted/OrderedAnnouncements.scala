...
/** Represents an ordered set of OracleAnnouncementTLVs The ordering represents
  * the ranked preference of the user
  */
...
/** Represents an ordered set of OracleAnnouncementV0TLV The ordering represents
  * the ranked preference of the user
  */
