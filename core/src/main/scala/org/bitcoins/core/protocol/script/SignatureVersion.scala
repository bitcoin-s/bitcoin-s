...
/** Represents the transaction digest algorithm for signature verification in
  * Bitcoin Core With the implementation of segwit, we have added different
  * algorithm, the first alternative being BIP143
...
/** The digest algorithm implemented by BIP143
  * [[https://github.com/bitcoin/bips/blob/master/bip-0143.mediawiki]]
  */
