...
sealed abstract class LnPolicy {
  ...
  /** The "amount_msat" field has been artificially limited to a UInt32. This
    * means that the current maximum transaction that can be completed over the
    * lightning network is 4294967295 MilliSatoshi. This is a self imposed
    * limit, and is subject to change. Please see
