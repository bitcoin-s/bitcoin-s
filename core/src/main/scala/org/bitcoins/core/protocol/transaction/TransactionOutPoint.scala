...
/** UInt32s cannot hold negative numbers, but sometimes the Bitcoin Protocol
  ...
  *
  * @see
  *   [[https://github.com/bitcoin/bitcoin/blob/d612837814020ae832499d18e6ee5eb919a87907/src/primitives/transaction.h transaction.h]]
  * @see
...
object TransactionOutPoint
  ...
  /** @param txId
    *   The transaction id for the crediting transaction for this input
    * @param vout
    *   The output index in the parent transaction for the output we are
    *   spending
    */
