...
/** [[org.bitcoins.chain.blockchain.ChainHandler]] cannot find a compact filter
  * or header by its filter hash
  */
case class UnknownFilterHash(message: String) extends ChainException(message)

/** [[org.bitcoins.chain.blockchain.ChainHandler]] cannot find a blockchain item
  * by its block hash
  */
...
/** [[org.bitcoins.chain.blockchain.ChainHandler]] tried to process multiple
  * filters for the same block hash
  */
