...
/** Represents a [[GolombFilter]] with it's
  * [[org.bitcoins.core.gcs.FilterHeader]] associated with it This is needed
  * because bitcoin core's 'getblockfilter' rpc returns things in this structure
  * @see
