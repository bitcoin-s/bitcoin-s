...
- `createlargerangeevent` `name` `maturationtime` `base` `numdigits` `unit` `precision` `[signed]` - Registers an oracle event with a large number for its outcomes
  - `name`- Name for this event
  - `maturationtime` - The earliest expected time an outcome will be signed, given in epoch second
...
- `signlargenumber` `event` `outcome` - Signs an event
  - `event` - The event's oracle event tlv
...
$ bitcoin-s-cli signnumber fdd8082a5858702d9395c60739e16c29e20ada0a49e4baa499f69fbc6b65a88fa9f3a7d000000000000000640001 50
...
$ curl --data-binary '{"jsonrpc": "1.0", "id": "curltest", "method": "signnumber", "params": ["fdd8082a5858702d9395c60739e16c29e20ada0a49e4baa499f69fbc6b65a88fa9f3a7d000000000000000640001", 50]}' -H "Content-Type: application/json" http://127.0.0.1:9999/
...
```bash
$ bitcoin-s-cli createlargerangeevent exampleLargeRange 1701917137 10 3 "units" 0 --signed
...
bitcoin-s-cli signlargenumber  123
[
  "abb84920cb647b1dc2bbbc6b1584af8d0a1a737fe0765d7414ebffcfd9c7057da391ea18b22f695bf8a34caa5a12acbdc917aea95990dbbf9568ca65676e6b7b",
...
```
$ curl --data-binary '{"jsonrpc": "1.0", "id": "curltest", "method": "createlargerangeevent", "params": ["exampleLargeRange1", 1701917137, 10, true, 3, "units", 0]}' -H "Content-Type: application/json" http://127.0.0.1:9999/
...
$ curl --data-binary '{"jsonrpc": "1.0", "id": "curltest", "method": "signlargenumber", "params": ["", 123]}' -H "Content-Type: application/json" http://127.0.0.1:9999/
