...
val psbtWithUpdatedFirstInput = psbtWithUTXOs.addRedeemOrWitnessScriptToInput(
...
val psbtFirstSig =
    psbtWithSigHashFlags.sign(inputIndex = 0, signer = privKey0)

val psbtSecondSig =
    psbtWithSigHashFlags.sign(inputIndex = 0, signer = privKey1)
...
val base64 = psbtSecondSig.base64
...
// have one PSBT with all of the necessary data
  val combinedPSBT = fromBase64.combinePSBT(psbtSecondSig)
