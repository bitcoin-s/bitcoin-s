...
trait BitcoinJTestUtil {
  ...
  def key1 =
    new DumpedPrivateKey(
      params,
      "cVLwRLTvz3BxDAWkvS3yzT9pUcTCup7kQnfT2smRjvmmm1wAP6QT").getKey();

  def key2 =
    new DumpedPrivateKey(
      params,
      "cTine92s8GLpVqvebi8rYce3FrUYq78ZGQffBYCS1HmDPJdSTxUo").getKey();

  def key3 =
    new DumpedPrivateKey(
      params,
      "cVHwXSPRZmL9adctwBwmn4oTZdZMbaCsR5XF6VznqMgcvt1FDDxg").getKey();

  def multiSigScript: org.bitcoinj.script.Script =
  ...
  def multiSigTransaction: org.bitcoinj.core.Transaction = {
    ...
    val creditingTx = new org.bitcoinj.core.Transaction(
      params,
      BitcoinSUtil.decodeHex(txHex).toArray)
    val output = creditingTx.getOutput(1)
    val spendTx = new org.bitcoinj.core.Transaction(params)
    val address = new org.bitcoinj.core.Address(
      params,
      "n3CFiCmBXVt5d3HXKQ15EFZyhPz4yj5F3H")
    val outputScript =
      org.bitcoinj.script.ScriptBuilder.createOutputScript(address)
  ...
  def signedMultiSigTransaction: (org.bitcoinj.core.Transaction, Int, Script) = {
    ...
    val txHex =
      ""
    val multisigScript = ScriptBuilder.createMultiSigOutputScript(
      2,
      util.Arrays.asList(key1, key2, key3));
  ...
  def p2shTransactionWithSpendingInputAndCreditingOutput: (
    ...
    val creditingTx = new org.bitcoinj.core.Transaction(
      params,
      BitcoinSUtil.decodeHex(rawCreditingTx).toArray)

    val spendingRawTx = TestUtil.rawP2SH2Of2Tx
    val spendingTx = new org.bitcoinj.core.Transaction(
      params,
      BitcoinSUtil.decodeHex(spendingRawTx).toArray)
    val inputIndex = 0
