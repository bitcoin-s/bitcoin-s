...
trait BitcoinJTestUtil {
  ...
  def multiSigScript: org.bitcoinj.script.Script = ScriptBuilder.createMultiSigOutputScript(
    2,
  ...
  def signedMultiSigTransaction: (org.bitcoinj.core.Transaction, Int, Script) = {
    ...
    val inputScript = ScriptBuilder.createMultiSigInputScript(ImmutableList.of(
   ...
   * @return
   */
  def p2shTransactionWithSpendingInputAndCreditingOutput: (org.bitcoinj.core.Transaction, org.bitcoinj.core.TransactionInput, Int, org.bitcoinj.core.TransactionOutput) = {
