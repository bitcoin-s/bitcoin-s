...
import org.bitcoins.core.protocol.transaction.{TransactionOutput, TransactionInput, Transaction}
import spray.json._
 ...
 */
object TransactionSerializer extends DefaultJsonProtocol with MarshallerUtil {
  val txIdKey = "txid"
  ...
  implicit object TransactionFormatter extends RootJsonFormat[Transaction] {
    ...
    override def write(tx : Transaction) : JsValue = {
      import TransactionInputSerializer._
      import TransactionOutputSerializer._
