...
class TransactionInputMarshallerTest extends FlatSpec with MustMatchers {
  ...
  "TransactionInputMarshaller" must "marshall a json input" in {
    val expectedScript = List(OP_0, BytesToPushOntoStackFactory.fromNumber(72).get,
      ...
      BytesToPushOntoStackFactory.fromNumber(72).get,
      ...
      OP_PUSHDATA1, ScriptNumberFactory.fromNumber(105),
