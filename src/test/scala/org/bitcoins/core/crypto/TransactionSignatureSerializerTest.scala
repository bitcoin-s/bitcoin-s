...
class TransactionSignatureSerializerTest extends FlatSpec with MustMatchers with BitcoinSLogger {
  ...
  it must "" in {
    ...
    val inputIndex = UInt32(11)
    val wtx = WitnessTransaction(rawTx)
    val scriptPubKeyFromString = ScriptParser.fromString("DUP HASH160 0x14 0x4c9c3dfac4207d5d8cb89df5722cb3d712385e3f EQUALVERIFY CHECKSIG")
    val scriptPubKey = ScriptPubKey.fromAsm(scriptPubKeyFromString)
    val amount = Satoshis(Int64(1011))
    val serializedForSig = TransactionSignatureSerializer.serializeForSignature(wtx,inputIndex,scriptPubKey.asm,HashType.sigHashAll)

    BitcoinSUtil.encodeHex(serializedForSig) must be ("")
  }
