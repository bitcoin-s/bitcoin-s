...
class RawTransactionInputParserTest extends FlatSpec with MustMatchers with RawTransactionInputParser {
  ...
  "RawTransactionInputParser" must "parse a raw serialized transaction input" in {
    ...
    txInputs.head.previousOutput.txId.hex must be ("e17d316006850c1764301befcf82c8c84cd1794f3f0d0382b296df2edab0d685")
  ...
  it must "parse a multiple raw serialized inputs" in {
    ...
    firstInput.previousOutput.txId.hex must be ("0140d0ed6c9feeb68ea727723a82bbaf0d143fc1d3810265d4dca7ebe6e380df")
    ...
    secondInput.previousOutput.txId.hex must be ("0140d0ed6c9feeb68ea727723a82bbaf0d143fc1d3810265d4dca7ebe6e380df")
  ...
  it must "write multiple inputs from a tx with a locktime" in {
    ...
    txInputs(1).previousOutput.txId.hex must be ("3063ca8537bd097ba0c2e9dfdd40e373aa0b61c2bb0594fbfd3e04b331922136")
  ...
  it must "parse a single input that uses a VarInt push operation" in {
    ...
    txInput.head.previousOutput.txId.hex must be ("e99eb3e6551844d0db252ef242c043796b3b0ccfb126c0ae09f9dd0230e2f10d")
    ...
    txInput2.previousOutput.txId.hex must be ("808105ed5feff1c05daf6efd202e5966fcdda71ca961e393a1fc83f2b03315d1")
  ...
  it must "must parse a tx from mainnet with multiple serialized inputs with VarInt push operations for the scriptSig" in {
    ...
    firstInput.previousOutput.txId.hex must be ("e99eb3e6551844d0db252ef242c043796b3b0ccfb126c0ae09f9dd0230e2f10d")
    ...
    txInputs(1).previousOutput.txId.hex must be ("808105ed5feff1c05daf6efd202e5966fcdda71ca961e393a1fc83f2b03315d1")
    txInputs(1).previousOutput.vout must be (0)
  ...
  it must "parse this transaction input and its script signature" in {
    ...
    inputs.head.previousOutput.txId.hex must be ("65bd23d3fb0ac9d3ee0195aae8d033d6689dacf71907902b27a7ad6f6441a7cd")
