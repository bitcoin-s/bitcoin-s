...
class RawTransactionOutputParserTest extends FlatSpec with MustMatchers {
  ...
  "RawTransactionOutputTest" must "read a serialized tx output" in {
    ...
    txOutput.scriptPubKey.asm must be(Seq(OP_HASH160, BytesToPushOntoStack(20), ScriptConstant("eda8ae08b5c9f973f49543e90a7c292367b3337c"), OP_EQUAL))
  }
  ...
  it must "serialize an older raw transaction output" in {
    ...
    val txOutput = "00f2052a01000000434104678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5fac"
