 ...
 */
class ScriptSignatureSerializerTest extends FlatSpec with MustMatchers {
  ...
  "ScriptSignatureMarshaller" must "parse a json script signature object" in {
    val scriptSig : ScriptSignature = ScriptSignatureSerializer.ScriptSignatureFormatter.read(json.parseJson)
