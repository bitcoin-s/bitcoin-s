...
case class Base58TestCaseImpl(addressOrWIFPrivKey : Either[Address, String], hashOrPrivKey : Either[Sha256Hash160Digest, ECPrivateKey],
                              configParams: ConfigParams) extends Base58TestCase