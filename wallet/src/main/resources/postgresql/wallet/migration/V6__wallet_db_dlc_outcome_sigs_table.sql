...
ALTER TABLE "wallet_dlc_accepts" DROP COLUMN "winSig", DROP COLUMN "loseSig", DROP COLUMN "refundSig";

-- This block drops the signature columns from wallet_dlcs
ALTER TABLE "wallet_dlcs" DROP COLUMN "initiatorWinSig", DROP COLUMN "initiatorLoseSig", DROP COLUMN "initiatorRefundSig";
