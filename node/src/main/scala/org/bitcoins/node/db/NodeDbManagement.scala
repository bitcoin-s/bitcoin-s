...
object NodeDbManagement extends DbManagement {
  ...
  def createBlockHeaderTable(dbConfig: DbConfig)(implicit ec: ExecutionContext): Future[Unit] = {
    createTable(blockHeaderTable,dbConfig)
  }

  def dropBlockHeaderTable(dbConfig: DbConfig)(implicit ec: ExecutionContext): Future[Unit] = {
