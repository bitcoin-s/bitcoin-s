...
object Deps {
  ...
  object V {
    ...
    val dropwizardMetricsV = "4.2.33" // https://github.com/dropwizard/metrics
    val dropWizardMetrics5V = "5.0.1"
    ...
    val slickV = "3.6.1"
    val sqliteV = "3.50.2.0" // https://github.com/xerial/sqlite-jdbc

    val scalameterV = "0.17"
    val scalamockV = "7.4.0"
