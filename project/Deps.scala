...
object Deps {
  ...
  object V {
    ...
    val logback = "1.4.6" //https://github.com/qos-ch/logback
    val log4jV = "1.2.17"
    ...
    val slickV = "3.4.1"
    val sqliteV = "3.41.0.0" //https://github.com/xerial/sqlite-jdbc
    ...
    // CLI deps
    val scoptV = "4.1.0"
    val sttpV = "3.8.13" // https://github.com/softwaremill/sttp
    val codehausV = "3.1.9"
