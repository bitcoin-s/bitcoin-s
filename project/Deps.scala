...
object Deps {
  ...
  object V {
    ...
    val logback = "1.5.34" // https://github.com/qos-ch/logback
    val log4jV = "1.2.17"
    ...
    val postgresV = "42.7.11" // https://jdbc.postgresql.org/
    val akkaActorV = akkaStreamv

    val slickV = "3.6.1"
    val sqliteV = "3.53.2.0" // https://github.com/xerial/sqlite-jdbc
    ...
    val zstdJniV = "1.5.7-10" // https://github.com/luben/zstd-jni
