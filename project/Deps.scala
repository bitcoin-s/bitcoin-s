...
object Deps {
  ...
  object V {
    ...
    val flywayV =
      "11.2.0" // https://flywaydb.org/documentation/learnmore/releaseNotes
    val postgresV = "42.7.5" // https://jdbc.postgresql.org/
    val akkaActorV = akkaStreamv

    val slickV = "3.5.2"
    val sqliteV = "3.48.0.0" // https://github.com/xerial/sqlite-jdbc
    ...
    // CLI deps
    val scoptV = "4.1.0"
    val sttpV = "3.10.2" // https://github.com/softwaremill/sttp
