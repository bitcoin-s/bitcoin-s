...
object Deps {
  ...
  object V {
    ...
    val logback = "1.5.25" // https://github.com/qos-ch/logback
    val log4jV = "1.2.17"
    ...
    val postgresV = "42.7.9" // https://jdbc.postgresql.org/
    val akkaActorV = akkaStreamv

    val slickV = "3.6.1"
    val sqliteV = "3.51.1.0" // https://github.com/xerial/sqlite-jdbc

    val scalameterV = "0.17"
    val scalamockV = "7.5.3"
