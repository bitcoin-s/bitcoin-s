...
object Deps {
  ...
  object V {
    ...
    val scalapb = "0.11.14"
    val akkav = "10.2.10"
    val playv = "3.0.1" //https://github.com/playframework/play-json/releases
    ...
    val slickV = "3.4.1"
    val sqliteV = "3.42.0.1" //https://github.com/xerial/sqlite-jdbc
    ...
    // CLI deps
    val scoptV = "4.1.0"
    val sttpV = "3.9.0" // https://github.com/softwaremill/sttp
