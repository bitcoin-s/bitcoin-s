...
object Deps {
  ...
  object V {
    ...
    val logback = "1.6.1" // https://github.com/qos-ch/logback
    val log4jV = "1.2.17"
    ...
    val scalaTestPlus =
      "3.2.20.0" // super annoying... https://oss.sonatype.org/content/groups/public/org/scalatestplus/
    val slf4j = "2.0.18"
    val spray = "1.3.6"
    val zeromq = "0.5.4"
    val scalapb = "0.11.20"
    ...
    val slickV = "3.6.1"
    val sqliteV = "3.53.2.1" // https://github.com/xerial/sqlite-jdbc
    ...
    val zstdJniV = "1.5.7-15" // https://github.com/luben/zstd-jni
    ...
    val conscryptV = "2.6.3" // https://github.com/google/conscrypt
    val jettyAlpnV =
    ...
    val nettyV = "4.2.17.Final" // https://github.com/netty/netty
    val jbossModulesV =
      jbossMarshallingV // https://github.com/jboss-modules/jboss-modules

    val reactorCoreV = "3.8.7" // https://github.com/reactor/reactor-core
    val rxjava2V = "2.2.21" // https://github.com/ReactiveX/RxJava
    val micrometerCoreV =
      "1.17.1" // https://github.com/micrometer-metrics/micrometer
  ...
  object Compile {
    ...
    val scalaTestPlus = Def.setting(
      "org.scalatestplus" %%% "scalacheck-1-19" % V.scalaTestPlus withSources () withJavadoc ())
